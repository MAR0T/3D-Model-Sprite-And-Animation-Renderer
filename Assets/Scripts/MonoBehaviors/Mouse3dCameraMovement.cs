...
public class Mouse3dCameraMovement : MonoBehaviour
{
    private Camera cam;
    ...
    public float MinCameraSize = 1f /8f, MaxCameraSize = 180;
    ...
    void Start()
    {
        ...
        currentCameraSize = cam.fieldOfView;
    }
    ...
    private void HandleZoonOnMousePosition()
    {
        ...
        cam.fieldOfView = currentCameraSize;
